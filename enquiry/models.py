...
class University(models.Model):
    ...
    course_level = models.ForeignKey(
        course_levels, on_delete=models.SET_NULL, null=True, blank=True
    )
    ...
    general_documents = models.ManyToManyField(
        documents_required, related_name="university_requirements"
    )
    mandatory_docs = models.ManyToManyField(
        documents_required,
        verbose_name=_("Mandatory Document"),
        related_name="university_requirement",
    )
    ...
    payment_option = models.ManyToManyField(
        Payment_Option, verbose_name=_("Payment Option")
    )
    ...
    english_test = models.ManyToManyField(
        EnglishTest, verbose_name=_("English Test Accepted")
    )
    ...
    board_not_eligible = models.ManyToManyField(
        boardNotEligible,
        verbose_name=_("Region or Boards not Eligible for English Waiver"),
    )
